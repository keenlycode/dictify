...
- [x] Inspect relevant current files.
- [x] Implement constructor API change.
- [x] Update tests.
...
- [ ] Prepare final 5.0.0 release metadata.
- [ ] Run final release validation.
- [ ] Merge to main, tag v5.0.0, and push.
- [ ] Publish package to PyPI and docs.
